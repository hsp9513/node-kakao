...
export class ChatManager {
    ...
    chatFromChatlog(chatLog: ChatlogStruct): Chat | null {
        ...
        return new TypedChat(channel, sender, chatLog.type, chatLog.messageId, chatLog.logId, chatLog.prevLogId, chatLog.sendTime, chatLog.text, chatLog.rawAttachment);
    }
